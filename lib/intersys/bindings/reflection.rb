module Intersys
  ...
  module Reflection
    ...
    class ClassDefinition < Intersys::Object
      # FIXME: I don't know why but CompiledClass doesn't work anymore
      # probably this is a temporary issue
    ...
    class PropertyDefinition < Intersys::Object
      class_name "%Dictionary.CompiledProperty"
    end

    class MethodDefinition < Intersys::Object
      class_name "%Dictionary.CompiledMethod"
    end
